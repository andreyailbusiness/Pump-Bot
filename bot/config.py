...
class Settings(BaseSettings):
    ...
    pump_min_body_atr_long: float = Field(default=0.35, alias="PUMP_MIN_BODY_ATR_LONG")
    pump_min_body_atr_short: float = Field(default=0.40, alias="PUMP_MIN_BODY_ATR_SHORT")
    pump_max_range_atr: float = Field(default=3.5, alias="PUMP_MAX_RANGE_ATR")
    pump_breakout_buffer_atr: float = Field(default=0.10, alias="PUMP_BREAKOUT_BUFFER_ATR")
    pump_continuation_min_ratio_long: float = Field(default=0.985, alias="PUMP_CONTINUATION_MIN_RATIO_LONG")
    pump_continuation_max_ratio_short: float = Field(default=1.015, alias="PUMP_CONTINUATION_MAX_RATIO_SHORT")
    ...
    paper_staged_final_r: bool = Field(default=False, alias="PAPER_STAGED_FINAL_R")
    paper_stage3_r: float = Field(default=5.0, alias="PAPER_STAGE3_R")
